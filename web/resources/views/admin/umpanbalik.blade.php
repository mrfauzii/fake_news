...
@section('content')
    ...
    <div class="page-header-top">
        ...
        <form action="{{ url('/admin/umpanbalik') }}" method="GET" class="search-wrapper">
            <input type="text" name="search" id="searchFeedback" class="search-input" placeholder="Search..."
                ...
                <div class="umpanbalik-left">
                    <div>
                        ...
                        <div class="umpanbalik-actions">
                            <button class="btn-detail" data-username="{{ $item->username }}"
        ...
        <div class="popup-box">
            ...
            <div class="popup-info">
                ...
                <div class="info-card">
                    ...
                    <div class="info-value" id="popupinput">
                    </div>
                    ...
                    <div class="info-value" id="popupResult">
                    </div>
    ...
    <style>
        ...
        #popupinput {
            text-align: left;
            /* KUNCI: Paksa teks untuk selalu rata kiri */
            word-wrap: break-word;
            /* Mencegah teks panjang menembus kotak */
            white-space: pre-wrap;
            /* Mempertahankan spasi dan enter (baris baru) dari teks asli */
        }

        #popupinput img {
            max-width: 100%;
            max-height: 200px !important;
            /* PAKSA gambar agar tingginya maksimal 200px */
            object-fit: contain;
            /* Gambar menyesuaikan rasio asli, tidak akan gepeng */
            border-radius: 8px;
            display: block;
            margin: 0 auto;
        }
        ...
        #popupinput.image-mode {
            max-height: 400px;
            /* Batasi tinggi kontainer modal agar tidak terlalu panjang */
            display: block;
            /* Ubah dari flex ke block agar scroll berfungsi normal */
            text-align: center;
        }
        ...
        #popupinput.image-mode img {
            max-width: 100%;
            /* Gambar tidak akan lebih lebar dari modal */
            height: auto;
            /* Tinggi proporsional */
            display: block;
            margin: 0 auto;
